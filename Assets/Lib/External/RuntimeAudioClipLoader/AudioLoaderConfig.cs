...
{
    /// <summary>
    /// Configuration for <see cref="AudioLoader"/>. You should not change this once loading starts. If you want to use similar <see cref="AudioLoaderConfig"/> instance for another <see cref="AudioLoader"/> use <see cref="AudioLoaderConfig.Clone"/>.
    /// </summary>
